    ...
    <section id="services" className="scroll-mt-24 bg-surface py-24">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <SectionHeading
          ...
          title="Plumbing & gas fitting across Batemans Bay"
          description="From new home builds to renovations, hot water, blocked drains and emergency call-outs — licensed local service across the Eurobodalla."
        />
