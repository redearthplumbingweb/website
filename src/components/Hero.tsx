...
export function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-surface-dark text-white">
      ...
      <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-surface-dark/50 to-transparent" />
      ...
      <div className="relative z-10 mx-auto flex min-h-[82vh] max-w-6xl flex-col justify-center px-6 py-24 lg:px-8">
        ...
        <p className="hero-item hero-item-actions mt-5 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
          {siteConfig.tagline}
        </p>
